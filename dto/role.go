...
type AssignRoleToUserReq struct {
	User         string       `json:"user,omitempty" example:"luobei"`
	App          string       `json:"app,omitempty" example:"operations"`
...
type GetResourcePermissionsReq struct {
	User         string `json:"user,omitempty" form:"user,omitempty" example:"luobei"`                                               // 租户用户（兼容旧接口，可选）
	App          string `json:"app,omitempty" form:"app,omitempty" example:"operations"`                                             // 应用代码（兼容旧接口，可选）
