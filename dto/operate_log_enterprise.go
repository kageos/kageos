...
type CreateOperateLoggerReq struct {
	...
	Action     string `json:"action"`               // 操作类型（如：OnTableAddRow, OnTableUpdateRow, OnTableDeleteRows, form_submit, request_app 等）
	...
	Source     string `json:"source,omitempty"`     // 来源（如：browser、agent、api）
