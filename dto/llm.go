...
type LLMInfo struct {
	...
	MaxTokens                    int    `json:"max_tokens" example:"0"`
	DetectedMaxOutputTokens      int    `json:"detected_max_output_tokens" example:"128000"`
	DetectedMaxOutputTokenSource string `json:"detected_max_output_token_source" example:"provider_metadata"`
	EffectiveMaxOutputTokens     int    `json:"effective_max_output_tokens" example:"128000"`
	MaxOutputTokenSource         string `json:"max_output_token_source" example:"detected"`
	ContextWindow                int    `json:"context_window" example:"0"`
	DetectedContextWindow        int    `json:"detected_context_window" example:"128000"`
	DetectedContextWindowSource  string `json:"detected_context_window_source" example:"provider_metadata"`
	EffectiveContextWindow       int    `json:"effective_context_window" example:"128000"`
	ContextWindowSource          string `json:"context_window_source" example:"detected"`
...
type LLMCreateReq struct {
	...
	Timeout                      int     `json:"timeout" example:"300"`
	MaxTokens                    int     `json:"max_tokens" example:"0"`
	DetectedMaxOutputTokens      int     `json:"detected_max_output_tokens" example:"0"`
	DetectedMaxOutputTokenSource string  `json:"detected_max_output_token_source" example:"provider_metadata"`
	ContextWindow                int     `json:"context_window" example:"0"`
	DetectedContextWindow        int     `json:"detected_context_window" example:"0"`
	DetectedContextWindowSource  string  `json:"detected_context_window_source" example:"provider_metadata"`
	ExtraConfig                  *string `json:"extra_config" example:"{}"`
	Capabilities                 *string `json:"capabilities" example:"{}"`
...
type LLMProbeResp struct {
	...
	MaxOutputTokenSource string            `json:"max_output_token_source,omitempty"`
