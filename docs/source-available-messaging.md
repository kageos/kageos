...
本文是 kageos 官网、README、Hub、视频、社媒、演示、工作台回答和商务材料的统一口径。

## 默认叙事

先讲用户价值，再在需要时说明授权：

> kageos 是源码公开、可自托管的服务目录平台。当前核心采用 BSL 1.1，各版本发布三年后转 Apache-2.0。
...
- 默认使用“源码公开、可自托管”，英文使用 “source-available and self-hostable”。
...
> kageos 把表单、表格、图表、文档、函数、消息和定时任务组织成可安装、可运行、可治理的服务目录。核心源码公开并支持自托管。

安装说明：

> 你可以查看 kageos 源码，并在 BSL 1.1 授权范围内部署到个人、团队或企业自己的环境。
...
发布官网、README、Hub 文案、视频字幕、社媒卡片或演示材料前，检查：

1. 标题和核心卖点是否围绕服务目录、私有运行、AI 可调用和平台治理，而不是围绕“开源”。
