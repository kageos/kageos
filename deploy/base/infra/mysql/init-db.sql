...
-- 各库与服务对应:
--   app_db       -> app-server
--   app-scheduled-task -> app-server scheduled task records
--   timer-scheduler -> central timer-scheduler
...
CREATE DATABASE IF NOT EXISTS `workflow-server` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
