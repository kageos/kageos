...
PROD_TEMPLATE_VARS='${MYSQL_ROOT_PASSWORD} ${JWT_SECRET} ${SYSTEM_USER_PASSWORD} ${MINIO_ROOT_PASSWORD} ${NATS_URL} ${SMTP_MODE} ${SMTP_HOST} ${SMTP_PORT} ${SMTP_USERNAME} ${SMTP_PASSWORD} ${SMTP_FROM} ${SMTP_FROM_NAME} ${KAGEOS_APP_BASE_IMAGE}'
