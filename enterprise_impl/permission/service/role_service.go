...
func (s *RoleService) InitDefaultRoles(ctx context.Context) error {
	...
	defaultRoles := []struct {
		...
		// Directory 资源类型的角色
		{
			...
			actions: []string{
				// 目录权限
				permissionpkg.BuildActionCode(permissionpkg.ResourceTypeDirectory, permissionpkg.ActionRead),
				// 子资源权限（目录查看者可以查看目录下所有常见资源）
				permissionpkg.BuildActionCode(permissionpkg.ResourceTypeTable, permissionpkg.ActionRead),
		...
		},
		{
			...
			actions: []string{
				// 目录权限
				permissionpkg.BuildActionCode(permissionpkg.ResourceTypeDirectory, permissionpkg.ActionRead),
				permissionpkg.BuildActionCode(permissionpkg.ResourceTypeDirectory, permissionpkg.ActionWrite),
				permissionpkg.BuildActionCode(permissionpkg.ResourceTypeDirectory, permissionpkg.ActionUpdate),
				// 子资源权限（目录开发者可以操作目录下的常见资源）
				permissionpkg.BuildActionCode(permissionpkg.ResourceTypeTable, permissionpkg.ActionRead),
				permissionpkg.BuildActionCode(permissionpkg.ResourceTypeTable, permissionpkg.ActionWrite),
				permissionpkg.BuildActionCode(permissionpkg.ResourceTypeTable, permissionpkg.ActionUpdate),
				permissionpkg.BuildActionCode(permissionpkg.ResourceTypeTable, permissionpkg.ActionDelete),
				permissionpkg.BuildActionCode(permissionpkg.ResourceTypeForm, permissionpkg.ActionRead),
				permissionpkg.BuildActionCode(permissionpkg.ResourceTypeForm, permissionpkg.ActionWrite),
				permissionpkg.BuildActionCode(permissionpkg.ResourceTypeChart, permissionpkg.ActionRead),
				permissionpkg.BuildActionCode(permissionpkg.ResourceTypeDocs, permissionpkg.ActionRead),
		...
		},
		{
			...
			actions: []string{
				// 目录权限
				permissionpkg.BuildActionCode(permissionpkg.ResourceTypeDirectory, permissionpkg.ActionAdmin),
				// 子资源权限（目录管理员拥有所有子资源类型的所有权限）
				permissionpkg.BuildActionCode(permissionpkg.ResourceTypeTable, permissionpkg.ActionAdmin),
		...
		// Table 资源类型的角色
		{
			...
			isDefault:    true, // ⭐ 默认角色
			actions:      []string{permissionpkg.BuildActionCode(permissionpkg.ResourceTypeTable, permissionpkg.ActionRead)},
		},
		{
			resourceType: permissionpkg.ResourceTypeTable,
			name:         "开发者",
		...
		},
		{
			...
			isDefault:    false,
			actions:      []string{permissionpkg.BuildActionCode(permissionpkg.ResourceTypeTable, permissionpkg.ActionAdmin)},
		},
		// Form 资源类型的角色
		{
			...
			isDefault:    true, // ⭐ 默认角色
			actions:      []string{permissionpkg.BuildActionCode(permissionpkg.ResourceTypeForm, permissionpkg.ActionRead)},
		},
		{
			resourceType: permissionpkg.ResourceTypeForm,
			name:         "开发者",
		...
		},
		{
			...
			isDefault:    false,
			actions:      []string{permissionpkg.BuildActionCode(permissionpkg.ResourceTypeForm, permissionpkg.ActionAdmin)},
		},
		// Chart 资源类型的角色
		{
			...
			isDefault:    true, // ⭐ 默认角色
			actions:      []string{permissionpkg.BuildActionCode(permissionpkg.ResourceTypeChart, permissionpkg.ActionRead)},
		},
		{
			resourceType: permissionpkg.ResourceTypeChart,
			name:         "管理员",
			...
			isDefault:    false,
			actions:      []string{permissionpkg.BuildActionCode(permissionpkg.ResourceTypeChart, permissionpkg.ActionAdmin)},
		},
		// App 资源类型的角色
		{
			...
			isDefault:    false,
			actions:      []string{permissionpkg.BuildActionCode(permissionpkg.ResourceTypeApp, permissionpkg.ActionAdmin)},
		},
		// Docs 资源类型的角色
		{
			...
			isDefault:    true, // ⭐ 默认角色
			actions:      []string{permissionpkg.BuildActionCode(permissionpkg.ResourceTypeDocs, permissionpkg.ActionRead)},
		},
		{
			resourceType: permissionpkg.ResourceTypeDocs,
			name:         "开发者",
