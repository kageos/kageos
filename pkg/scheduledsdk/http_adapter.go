...
var _ ExecutionEventAdapter = (*HTTPAdapter)(nil)
...
func (a *HTTPAdapter) PublishExecutionRequested(ctx context.Context, event ExecutionRequestedEvent) error {
	return a.doJSON(ctx, http.MethodPost, "/events/execution_requested", nil, event, nil)
}
