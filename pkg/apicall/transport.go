...
func applyCommonHeaders(req *http.Request, ctx context.Context) {
	...
	for _, item := range []struct {
		...
		{contextx.SourceIconHeader, contextx.GetSourceIcon(ctx)},
		{contextx.SourceColorHeader, contextx.GetSourceColor(ctx)},
		{contextx.SourceParentIconHeader, contextx.GetSourceParentIcon(ctx)},
		{contextx.SourceParentColorHeader, contextx.GetSourceParentColor(ctx)},
