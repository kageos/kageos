        ...
        "/workspace/api/v1/operate_log/general": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "资源类型：table/form/permission/directory/function",
                        "name": "resource_type",
                        "in": "query"
                    },
                    {
        ...
        "dto.CopyDirectoryReq": {
            ...
            "properties": {
                ...
                "target_directory_name": {
                    "description": "复制后根目录中文展示名",
                    "type": "string",
                    "example": "人事管理"
                },
                "target_directory_path": {
                    "description": "目标父目录完整路径",
                    "type": "string",
                    "example": "/luobei/app_b"
                }
            }
        },
        "dto.CopyDirectoryResp": {
            ...
            "properties": {
                ...
                "message": {
                    "description": "响应消息",
                    "type": "string",
                    "example": "复制目录成功，共复制 3 个目录，15 个文件，2 份文档，1 个 Agent 任务"
                },
                "new_version": {
                    "description": "新版本号",
                    "type": "string",
                ...
                "replaced": {
                    "description": "是否执行了同名目录完全替换",
                    "type": "boolean"
                },
                "target_directory_path": {
                    "description": "最终目标目录完整路径",
                    "type": "string"
                }
            }
        },
