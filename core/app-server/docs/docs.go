...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/workspace/api/v1/boards/crud/{id}": {
            "put": {
                "summary": "更新版块",
                "parameters": [
                    {
        ...
        "/workspace/api/v1/operate_log/form": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "来源：browser, scheduled_task, agent, api",
                        "name": "source",
                        "in": "query"
                    },
                    {
        ...
        "/workspace/api/v1/service_tree/search_resources": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "资源类型（all/package/function/docs/board）",
                        "name": "resource_type",
                        "in": "query"
                    },
                    {
        ...
        "/workspace/api/v1/table/batch-create/{full-code-path}": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
    ...
    "definitions": {
        ...
        "dto.UpdateBoardReq": {
            ...
            "properties": {
                ...
                "id": {
                    "description": "由 path 提供，body 可不传",
                    "type": "integer"
                },
                "name": {
                    "type": "string"
        ...
        "functionschema.FunctionSchema": {
            ...
            "properties": {
                ...
                "chart": {
                    "$ref": "#/definitions/functionschema.ChartSchema"
                },
                "form": {
                    "$ref": "#/definitions/functionschema.FormSchema"
                },
                "table": {
                    "$ref": "#/definitions/functionschema.TableSchema"
                },
                "type": {
                    "type": "string"
                },
