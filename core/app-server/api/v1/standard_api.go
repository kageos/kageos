...
func (s *StandardAPI) buildRequestAppReq(c *gin.Context, fullCodePath string) (*dto.RequestAppReq, error) {
	...
	req := &dto.RequestAppReq{
		...
		SourceIcon:            contextx.GetSourceIcon(c),
		SourceColor:           contextx.GetSourceColor(c),
		SourceParentIcon:      contextx.GetSourceParentIcon(c),
		SourceParentColor:     contextx.GetSourceParentColor(c),
