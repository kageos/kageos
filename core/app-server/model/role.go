...
type RolePermission struct {
	...
	ResourceType string `json:"resource_type" gorm:"type:varchar(20);not null;index;comment:资源类型：directory、table、form、chart、app"`
	Action       string `json:"action" gorm:"type:varchar(50);not null;index;comment:权限点"`
