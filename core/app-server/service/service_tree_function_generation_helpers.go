...
func addFunctionsImpl(s *ServiceTreeService, ctx context.Context, req *dto.AddFunctionsReq) (*dto.AddFunctionsResp, error) {
...
func processFunctionGenResultImpl(s *ServiceTreeService, ctx context.Context, req *dto.AddFunctionsReq) error {
	if strings.TrimSpace(req.FullCodePath) == "" {
