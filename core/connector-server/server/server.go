...
func (s *Server) initRouter(ctx context.Context) error {
	...
	apiV1.GET("/directory-bindings", connectorHandler.ListDirectoryBindings)
	apiV1.POST("/directory-bindings", connectorHandler.BindDirectory)
	apiV1.DELETE("/directory-bindings", connectorHandler.DeleteDirectoryBinding)
