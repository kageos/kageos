...
func (r *TimerTaskRepository) Create(ctx context.Context, task *model.TimerTask) error {
	return r.db.WithContext(ctx).Create(task).Error
}

func (r *TimerTaskRepository) Update(ctx context.Context, task *model.TimerTask) error {
	return r.db.WithContext(ctx).Save(task).Error
}

func (r *TimerTaskRepository) GetByID(ctx context.Context, id int64) (*model.TimerTask, error) {
...
func (r *TimerTaskRepository) GetByIDForUpdate(ctx context.Context, id int64) (*model.TimerTask, error) {
	var task model.TimerTask
...
func (r *TimerTaskRepository) GetByIdempotencyKey(ctx context.Context, key string) (*model.TimerTask, error) {
...
func (r *TimerTaskRepository) ReleaseIdempotencyKey(ctx context.Context, id int64, key string) error {
	key = strings.TrimSpace(key)
	if id <= 0 || key == "" {
		return nil
	}
	result := r.db.WithContext(ctx).Model(&model.TimerTask{}).
...
func (r *TimerTaskRepository) List(ctx context.Context, req ListTasksFilter) ([]*model.TimerTask, int64, error) {
	query := r.db.WithContext(ctx).Model(&model.TimerTask{})
	if req.ExecutorKey != "" {
...
func (r *TimerTaskRepository) ListDue(ctx context.Context, now time.Time, limit int) ([]*model.TimerTask, error) {
...
func (r *TimerTaskRepository) ListBrokenInflightReferences(ctx context.Context, limit int) ([]*model.TimerTask, error) {
	query := r.db.WithContext(ctx).Model(&model.TimerTask{}).
...
func (r *TimerTaskRepository) GetBrokenInflightReferenceByID(ctx context.Context, id int64) (*model.TimerTask, error) {
	var task model.TimerTask
	err := r.db.WithContext(ctx).Model(&model.TimerTask{}).
		Joins("LEFT JOIN timer_execution AS inflight_exec ON inflight_exec.id = timer_task.inflight_execution_id AND inflight_exec.task_id = timer_task.id").
...
func (r *TimerTaskRepository) TryAcquireDispatch(ctx context.Context, id int64, owner string, now, leaseUntil time.Time) (bool, error) {
	result := r.db.WithContext(ctx).Model(&model.TimerTask{}).
...
func (r *TimerTaskRepository) TryClearInflight(ctx context.Context, id, executionID int64, lastError string) (bool, error) {
	updates := map[string]interface{}{
...
func (r *TimerTaskRepository) TrySetInflight(ctx context.Context, taskID, executionID int64, leaseOwner string, nextRunAt *time.Time) (bool, error) {
	result := r.db.WithContext(ctx).Model(&model.TimerTask{}).
...
func (r *TimerTaskRepository) TrySetManualInflight(ctx context.Context, taskID, executionID int64) (bool, error) {
	result := r.db.WithContext(ctx).Model(&model.TimerTask{}).
...
func (r *TimerTaskRepository) RecordManualExecutionSubmitted(ctx context.Context, taskID, executionID int64) (bool, error) {
	result := r.db.WithContext(ctx).Model(&model.TimerTask{}).
		Where("id = ? AND status IN ?", taskID, []string{"pending", "paused"}).
...
func (r *TimerTaskRepository) TrySettleExecution(ctx context.Context, task *model.TimerTask, executionID int64, expectedStatus string, clearInflight bool) (bool, error) {
	updates := map[string]interface{}{
		"status":             task.Status,
...
func (r *TimerTaskRepository) Pause(ctx context.Context, id int64) error {
	return r.db.WithContext(ctx).Model(&model.TimerTask{}).
		Where("id = ? AND status = ?", id, "pending").
		Update("status", "paused").Error
}

func (r *TimerTaskRepository) Resume(ctx context.Context, id int64, nextRunAt *time.Time) error {
	return r.db.WithContext(ctx).Model(&model.TimerTask{}).
...
func (r *TimerTaskRepository) Cancel(ctx context.Context, id int64) error {
	return r.db.WithContext(ctx).Model(&model.TimerTask{}).
...
func (r *TimerTaskRepository) Delete(ctx context.Context, task *model.TimerTask) error {
