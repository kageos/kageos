...
func InitWorkspaceModes(db *gorm.DB) error {
	...
	for _, code := range codes {
		...
		case "execute":
			...
			m.SetToolNames([]string{"read_go_file", "read_go_file_lines", "read_doc", "read_dir", "search_tools", "run_table_search", "run_table_create", "run_table_update", "run_form_submit", "run_chart_query"})
		case "agent":
			m.Name = "Agent 模式"
			...
			m.SetToolNames([]string{"read_go_file", "read_go_file_lines", "read_doc", "read_dir", "search_tools", "write_doc", "write_go_file", "search_replace_file", "delete_file", "build_workspace", "create_directory", "run_table_search", "run_table_create", "run_table_update", "run_form_submit", "run_chart_query"})
		}
