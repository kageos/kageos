...
func InitWorkspaceModes(db *gorm.DB) error {
	...
	for _, code := range codes {
		...
		case "dev":
			...
			m.SetToolNames([]string{"read_go_file", "read_go_file_lines", "read_doc", "read_dir", "web_search", "fetch_url_content", "write_doc", "write_go_file", "search_replace_file", "delete_file", "read_app_log", "build_workspace", "create_directory", "create_scheduled_agent_task", "list_scheduled_agent_tasks", "list_scheduled_agent_task_executions", "run_scheduled_agent_task_now", "run_official_python"})
		case "modify":
			m.Name = "修改模式"
