...
type Plugin struct {
	...
	// Form 函数路径（full-code-path）
	// 例如：/system/official/agent/plugin/table_parse
	FormPath string `gorm:"type:varchar(512);not null;index;comment:Form函数路径(full-code-path)" json:"form_path"`
