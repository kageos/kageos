...
| 创建时间 | 更新时间 | 职位名称 | 部门 | 工作类型 | 工作经验 | 学历要求 | 工作地点 | 最低薪资 | 最高薪资 | 招聘人数 | 招聘状态 | 发布时间 | 截止时间 | 投递简历 |
|----------|----------|----------|------|----------|----------|----------|----------|----------|----------|----------|----------|----------|----------|----------|

**说明**：列表中「投递简历」link 仅当状态为「招聘中」且截止时间未到时展示，点击跳转 hr_resume_list 并带 job_id 预填。
...
| 投递时间 | 更新时间 | 职位名称 | 部门 | 姓名 | 联系电话 | 邮箱 | 学历 | 工作经验 | 投递状态 | 职位详情 |
|----------|----------|----------|------|------|----------|------|------|----------|----------|----------|

**说明**：列表中「职位名称」「部门」来自 Preload 的 Job；「职位详情」为 link 跳转职位列表对应职位。列表可筛职位名称（like）、部门（精确）。
