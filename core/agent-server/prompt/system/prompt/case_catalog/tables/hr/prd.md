...
| 工作类型   | 下拉选择 | ✓   | 全职   | 全职/兼职/实习/外包 |
| 工作经验   | 下拉选择 | ✓   | 不限   | 1-3年/3-5年/5-10年/10年以上/不限 |
| 学历要求   | 下拉选择 | ✓   | 不限   | 本科/硕士/博士/不限 |
| 工作地点   | 文本输入 | ✓   | —      | 2–100 字 |
| 最低薪资   | 数字输入 | ✗   | —      | 元，≥0 |
| 最高薪资   | 数字输入 | ✗   | —      | 元，≥0 |
| 职位描述   | 多行文本 | ✓   | —      | 至少 10 字 |
...
| ID | 创建时间 | 更新时间 | 创建人 | 职位名称 | 部门 | 工作类型 | 工作经验 | 学历要求 | 工作地点 | 最低薪资 | 最高薪资 | 招聘人数 | 招聘状态 | 发布时间 | 截止时间 | 操作 |
|----|----------|----------|--------|----------|------|----------|----------|----------|----------|----------|----------|----------|----------|----------|----------|------|
| 1 | 2025-01-15 10:00 | 2025-01-15 10:00 | — | Go 后端开发 | 技术 | 全职 | 3-5年 | 本科 | 北京 | 20000 | 35000 | 2 | 招聘中 | 2025-01-15 10:00 | 2025-02-15 18:00 | 删除、投递简历 |
| 2 | 2025-01-14 09:00 | 2025-01-16 14:00 | — | 产品经理 | 产品 | 全职 | 5-10年 | 硕士 | 上海 | 25000 | 40000 | 1 | 招聘中 | 2025-01-14 09:00 | 2025-02-10 18:00 | 删除、投递简历 |
...
| 简历内容   | 多行文本 | ✓   | —      | 至少 10 字 |
| 简历附件   | 文件上传 | ✗   | —      | 可选 |
| 投递状态   | 下拉选择 | ✓   | 待筛选 | 待筛选/已通过/已拒绝/待面试/已录用 |
| 备注       | 多行文本 | ✗   | —      | 可选 |
| 投递人     | 用户选择 | ✗   | Me()   | 只读，后端赋值 |

**列表模式**（可筛：职位名称、部门；职位名称、部门为关联展示）

| ID | 创建时间 | 更新时间 | 创建人 | 投递职位 | 姓名 | 联系电话 | 邮箱 | 性别 | 年龄 | 学历 | 工作经验 | 当前公司 | 当前职位 | 简历内容 | 简历附件 | 投递状态 | 备注 | 投递人 | 职位名称 | 部门 | 操作 |
|----|----------|----------|--------|----------|------|----------|------|------|------|------|----------|----------|----------|----------|----------|----------|------|--------|----------|------|------|
| 1 | 2025-01-18 11:00 | 2025-01-18 11:00 | 王五 | — | 王五 | 13800138000 | wang@example.com | — | — | 本科 | 3-5年 | — | — | — | — | 待筛选 | — | 王五 | Go 后端开发 | 技术 | 删除、查看职位详情 |
...
type HrJob struct {
	...
	Department   string `json:"department" gorm:"column:department;comment:部门" widget:"name:部门;type:select;options:技术,产品,设计,运营,市场,销售,人事,财务,其他;options_colors:409EFF,67C23A,E6A23C,909399,F56C6C,9C27B0,FF9800,607D8B" search:"in" validate:"required"`
	JobType      string `json:"job_type" gorm:"column:job_type;comment:工作类型;default:全职" widget:"name:工作类型;type:select;options:全职,兼职,实习,外包;options_colors:409EFF,67C23A,E6A23C,909399;render_default:全职" search:"in" validate:"required,oneof=全职 兼职 实习 外包"`
	Experience   string `json:"experience" gorm:"column:experience;comment:工作经验;default:不限" widget:"name:工作经验;type:select;options:1-3年,3-5年,5-10年,10年以上,不限;options_colors:909399,409EFF,67C23A,E6A23C,9E9E9E;render_default:不限" search:"in" validate:"required"`
	Education    string `json:"education" gorm:"column:education;comment:学历要求;default:不限" widget:"name:学历要求;type:select;options:本科,硕士,博士,不限;options_colors:909399,409EFF,67C23A,9E9E9E;render_default:不限" search:"in" validate:"required"`
	...
	Status       string `json:"status" gorm:"column:status;comment:招聘状态;default:招聘中" widget:"name:招聘状态;type:select;options:招聘中,已暂停,已关闭,已招满;options_colors:67C23A,E6A23C,F56C6C,909399;render_default:招聘中" search:"in" validate:"required,oneof=招聘中 已暂停 已关闭 已招满"`
...
type HrResume struct {
	...
	Gender          string       `json:"gender" gorm:"column:gender;comment:性别" widget:"name:性别;type:select;options:男,女,其他;options_colors:409EFF,67C23A,909399" search:"in"`
	Age             int          `json:"age" gorm:"column:age;comment:年龄" widget:"name:年龄;type:number" search:"gte,lte" validate:"min=18,max=100"`
	Education       string       `json:"education" gorm:"column:education;comment:学历" widget:"name:学历;type:select;options:本科,硕士,博士,其他;options_colors:909399,409EFF,67C23A,9E9E9E" search:"in"`
	Experience      string       `json:"experience" gorm:"column:experience;comment:工作经验" widget:"name:工作经验;type:select;options:1-3年,3-5年,5-10年,10年以上,应届生;options_colors:909399,409EFF,67C23A,E6A23C,9E9E9E" search:"in"`
	...
	Status          string       `json:"status" gorm:"column:status;comment:投递状态;default:待筛选" widget:"name:投递状态;type:select;options:待筛选,已通过,已拒绝,待面试,已录用;options_colors:909399,67C23A,F56C6C,E6A23C,67C23A;render_default:待筛选" search:"in" validate:"required,oneof=待筛选 已通过 已拒绝 待面试 已录用"`
