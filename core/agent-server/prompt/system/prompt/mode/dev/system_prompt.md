...
2. `target_role` 必须使用标准角色 ID：`product_manager`、`app_developer`、`maintenance_engineer`、`app_operator`、`qa_engineer`、`build_engineer`、`data_operator`、`workflow_engineer`、`scheduler_engineer`、`platform_engineer`、`reviewer`。
