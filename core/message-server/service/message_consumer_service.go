...
func normalizeMessageMeta(meta dto.MessageSendMeta) dto.MessageSendMeta {
	...
	meta.SourceIcon = strings.TrimSpace(meta.SourceIcon)
	meta.SourceColor = strings.TrimSpace(meta.SourceColor)
	meta.SourceParentIcon = strings.TrimSpace(meta.SourceParentIcon)
	meta.SourceParentColor = strings.TrimSpace(meta.SourceParentColor)
